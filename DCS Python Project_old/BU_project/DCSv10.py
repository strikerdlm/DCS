...
file_path = r"C:\Users\User\OneDrive\FAC\Research\Python Scripts\DCS\DCS_Risk_DB_2025.xlsx"
sheet_name = "data"
...
print("Intercept:", models[-1].init_.constant_[0][0])
...
df['prediction_uncertainty'] = y_std
df['safe_threshold'] = df['calculated'] + 2*y_std  # 95% CI
...
dump(models, r"C:\Users\User\OneDrive\FAC\Research\DCS FAC\trained_ensemble.joblib")
