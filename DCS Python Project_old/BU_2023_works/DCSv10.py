...
output_file_path = os.path.join(output_dir, "output_data_set.xlsx")
...
dump(model, os.path.join(output_dir, "trained_model.joblib"))
dump(onehot_encoder, os.path.join(output_dir, "onehot_encoder.joblib"))
dump(X.columns, os.path.join(output_dir, "column_names.joblib"))